...
- (void)hn_showDetailViewControllerWithFallback:(UIViewController *)controller {
    ...
    if ([controller isKindOfClass:[SFSafariViewController class]]) {
        SFSafariViewController *safariVC = (SFSafariViewController *)controller;
        [self showDetailViewController:safariVC sender:self]; // Show as detail view as opposed to full screen.
...
- (void)hn_dismissDetailViewControllerWithFallback:(UIViewController *)controller {
    ...
    if ([controller isKindOfClass:[SFSafariViewController class]]) {
        ...
        UIViewController *emptyVC = [sb instantiateViewControllerWithIdentifier:@"DetailNav"];
        [self showDetailViewController:emptyVC sender:self];
...
- (void)safariViewControllerDidFinish:(SFSafariViewController *)controller {
    [self hn_dismissDetailViewControllerWithFallback:controller];
}
